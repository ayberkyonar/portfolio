...
function saveOrders($customer_id, string $sushi_1, string $sushi_2, string $sushi_3, string $sushi_4, string $sushi_5, int $total): void
{
    global $pdo;

    $sth = $pdo->prepare('INSERT INTO orders (customer_id,sushi_1, sushi_2, sushi_3, sushi_4, sushi_5, total) VALUES (:c,:s1,:s2,:s3,:s4,:s5,:t)');
