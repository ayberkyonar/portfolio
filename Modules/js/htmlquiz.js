...
const questions = [
  {
    question: 'Welke H element heeft de grootste font?',
    answers: [
  ...
  {
    question: 'Welke lijst heeft cijfers?',
    answers: [
  ...
  {
    question: 'Wat heb je nodig om een link te maken?',
    answers: [
      { text: '<src>', correct: false },
      { text: '<a href>', correct: true },
      { text: '<a link>', correct: false },
      { text: '<src link>', correct: false }
    ]
  }
]